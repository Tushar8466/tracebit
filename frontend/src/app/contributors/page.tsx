...
export default function ContributorsPage() {
  ...
  const handleSearch = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch(
        `${backendUrl}/api/contributors?repo=${repoInput.trim()}`,
        { headers }
      );
  ...
  return (
    <BackgroundRippleEffect>
      <div className="min-h-screen bg-black flex flex-col items-center justify-center py-12 px-4 relative w-full">
        {/* HEADER */}
        <div className="text-center mb-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 flex flex-col items-center gap-3">
              ...
              <span className="text-xl md:text-2xl text-neutral-200">
                Repository Contributors
              </span>
            </h1>

            <p className="text-neutral-400 text-lg max-w-2xl mx-auto">
              Lookup any GitHub repository to analyze contributors using
        ...
        <form
          ...
          className="max-w-xl w-full mx-auto mb-16 relative"
        >
        ...
        {/* ERROR */}
        {error && (
          <div className="max-w-xl w-full mx-auto p-4 mb-8 bg-rose-500/10 border border-rose-500/20 rounded-xl text-rose-400 text-center">
            {error}
          </div>
        )}
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 p-6 bg-neutral-900/50 border border-neutral-800 rounded-2xl">
              <div>
                ...
                <p className="text-neutral-500 mt-1">
                  Fetched {contributors.length} top contributors
                </p>
              </div>
                    ...
                    <div className="w-full bg-neutral-800 rounded-full h-1.5 mt-3 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(
                            100,
                            Math.max(1, parseFloat(c.percentage))
                          )}%`,
                        }}
                      />
                    </div>
